...
export function AdminControlGroup({ title, children, className = "", key }: { title: string; children: React.ReactNode; className?: string; key?: string }) {
  return (
    <div key={key} className={`p-6 bg-slate-900/40 border border-slate-800 shadow-xl rounded-2xl space-y-4 ${className}`}>
